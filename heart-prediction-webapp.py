...
if st.button("Predict"):
     ...
     if egc == "Normal":
          egc_num=0
     elif egc == "Having ST-T wave abnormality (T wave inversions and/or ST elevation or depression of > 0.05 mV)":
          egc_num=1
     else:
          egc_num=2
     ...
     input_data = (age,sex_num,chest_pain_num,rest_blood,cholestrol,blood_sugar_num,egc_num,max_heart,exercise_num,depression,slope_num,major_vessel,thalium_num)
